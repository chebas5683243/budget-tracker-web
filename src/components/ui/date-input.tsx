...
function DateInput({ value, onChange }: DateInputProps) {
  ...
  const validateDate = (
    ...
    if (
      (field === "day" && (fieldValue < 1 || fieldValue > 31)) ||
      (field === "month" && (fieldValue < 1 || fieldValue > 12)) ||
      (field === "year" && (fieldValue < 1000 || fieldValue > 9999))
    ) {
      return false;
    }

    // Validate the day of the month
    const newDate = { ...date, [field]: fieldValue };
