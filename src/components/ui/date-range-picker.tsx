...
export function DateRangePicker({
  ...
  const setPreset = (preset: string): void => {
    ...
    if (rangeCompare) {
      const presetRangeCompare = {
        from: new Date(
          presetRange.from.getFullYear() - 1,
          presetRange.from.getMonth(),
          presetRange.from.getDate(),
        ),
        to: presetRange.to
          ? new Date(
              presetRange.to.getFullYear() - 1,
              presetRange.to.getMonth(),
              presetRange.to.getDate(),
            )
          : undefined,
      };
      setRangeCompare(presetRangeCompare);
    }
  };
